...
public class Board extends Group {
    ...
    private final Button bContinue = new Button("Go on");
    private final Button bContinueNo = new Button("Nope");
    ...
    private void createScore() {
        Label lblTitle = new Label("2048 GAME");
        ...
        Label lblTit = new Label("CURRENT SCORE");
        ...
        Label lblTitBest = new Label("BEST SCORE");
    ...
    private final Overlay wonListener= new Overlay("You win!","You are the best!",bContinue, bTry, "game-overlay-won", "game-lblWon",true);
    ...
    private void initGameProperties() {
        ...
        gameOverProperty.addListener(new Overlay("Game Over!","Want to make another game?",bTry, null, "game-overlay-over", "game-lblOver",false));
        gamePauseProperty.addListener(new Overlay("Game Paused","Stop at the current data",bContinue, null, "game-overlay-pause", "game-lblPause",true));
        ...
        gameAboutProperty.addListener((observable, oldValue, newValue) -> {
            if (newValue) {
                ...
                Text t03 = new Text("DSA Project\n");
                t03.getStyleClass().setAll("game-label","game-lblAbout");
               
                Text t23 = new Text("\u00A9 ");
                t23.getStyleClass().setAll("game-label", "game-lblAboutSub");
                Hyperlink link2 = new Hyperlink();
                link2.setText("HTT's Group");
                ...
                */
                ...
                flow.getChildren().setAll(t00, t01, t02, t03, t23, link2,  link3);
